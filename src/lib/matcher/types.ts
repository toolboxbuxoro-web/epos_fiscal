...
export interface MatcherOptions {
   ...
   */
  /**
   * Потолок штук ОДНОГО товара в одной строке чека.
   *
   * Без него подбор выедал дешёвые приходы лавиной: анкер с приходом 175 сум
   * после округления цены вверх до шага 1000 превращается в товар по 1000 сум
   * с идеальной кратностью, и алгоритм добивал им любую сумму — доходило до
   * 560 штук в одном чеке. За месяц так ушло 10 306 штук дешёвых товаров,
   * склад остался без «мелочи», и мелкие чеки стало не из чего собирать.
   *
   * Ограничение мягкое: если план с ним не сходится, подбор повторяется без
   * него (см. planHolistic). Заблокировать продажу ради красоты чека нельзя.
   */
